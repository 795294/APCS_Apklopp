...
/**
 * Write a description of class PixLabQuestions here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class PixLabQuestions
{
 ...
 * It takes 8 bits to represent all values from 0-255 (256 = 2^8).
 * 
 * 2. How many bytes does it take to represent a color in the RGB color model?
 * It takes 3 bytes (8 bits for each color in RGB) to represent a color in the RGB model.
 * 
 * 3. How many pixels are in a picture that is 640 pixels wide and 480 pixels high? 
 * There are 307,200 pixels in a picture that is 640x480.
*/
 ...
 * java.awt.Color[r=255,g=114,b=247]
 * 
 * 2. How can you make yellow? 
 * java.awt.Color[r=255,g=255,b=0]
 * 
 * 3. How can you make purple? 
 * java.awt.Color[r=136,g=0,b=255]
 * 
 * 4. How can you make white? 
 * java.awt.Color[r=255,g=255,b=255]
 * 
 * 5. How can you make dark gray? 
 * java.awt.Color[r=40,g=40,b=40]
 * 
 */
